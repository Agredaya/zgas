...
productoControllers.getEmployee =async(req,res)=>{
    const Products = await productModel.find()
    res.json(Products)
}
productoControllers.insertEmployee =async(req,res)=>{
...
productoControllers.updateEmployee =async(req,res)=>{ 
...
productoControllers.deleteEmployee= async (req,res)=>{
    const{name,desciption,price,stock}=req.body;
